        ...
        <div className='timeSlotBox'>
          <div className='row-ts'>
            <div className='col-ts'>
              ...
              className={clicked === '10'? 'tsBtnActive': 'tsBtn'}>10:00am</div>
              <div 
              onClick={()=> props.updateTimeSlot('11')} 
              className={clicked === '11'? 'tsBtnActive': 'tsBtn'}>11:00am</div>
              <div 
              onClick={()=> props.updateTimeSlot('12')} 
              className={clicked === '12'? 'tsBtnActive': 'tsBtn'}>12:00pm</div>
              <div 
              onClick={()=> props.updateTimeSlot('13')} 
              className={clicked === '13'? 'tsBtnActive': 'tsBtn'}>01:00pm</div>
            </div>
            <div className='col-ts'>
              <div 
              onClick={()=> props.updateTimeSlot('14')} 
              className={clicked === '14'? 'tsBtnActive': 'tsBtn'}>2:00pm</div>
              <div 
              onClick={()=> props.updateTimeSlot('15')} 
              className={clicked === '15'? 'tsBtnActive': 'tsBtn'}>3:00pm</div>
              <div 
              onClick={()=> props.updateTimeSlot('16')} 
              className={clicked === '16'? 'tsBtnActive': 'tsBtn'}>4:00pm</div>
              <div 
              onClick={()=> props.updateTimeSlot('17')} 
              className={clicked === '17'? 'tsBtnActive': 'tsBtn'}>5:00pm</div>
            </div>
          </div> 
